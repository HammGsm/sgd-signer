...
def _registrar_esquema():
    ...
    try:
        ...
        swift_src = (
            ...
            '        // doble clic (sin URL): abrir GUI tras un margen amplio para\n'
            '        // dar tiempo al AppleEvent kAEGetURL (el arranque Swift tarda\n'
            '        // >1s; 0.6s era demasiado corto y abría la GUI en vez de\n'
            '        // conectar cuando el navegador lanzaba tramitedoc://).\n'
            ...
            'let d = Delegate()\n'
            'app.delegate = d\n'
            '// .accessory oculta el handler del dock sin romper la captura de\n'
            '// kAEGetURL (LSUIElement en Info.plist SÍ la rompe: el evento no\n'
            '// se entrega a apps LSUIElement lanzadas por LaunchServices).\n'
